(function (root) {
  ...
  const MODULES = {
    vehicle_equipment: {
      title: "السيارات والمعدات",
      singular: "سيارة أو معدة",
      icon: "⚙",
      description: "سجل الأسطول والمعدات وحالتها الفنية والتشغيلية والتراخيص والصيانة والعهدة.",
      keyField: "assetName",
      columns: ["assetName", "assetType", "plateNumber", "eng", "custodian", "technicalCondition", "status", "licenseExpiry"],
      fields: [
        { key: "assetName", label: "اسم أو وصف السيارة/المعدة *", type: "text", required: true, maxLength: 300, full: true },
        { key: "assetType", label: "نوع الأصل *", type: "select", required: true, options: ["سيارة ملاكي", "سيارة نقل", "ربع نقل", "ميكروباص", "أتوبيس", "دراجة نارية", "حفار", "لودر", "ونش", "جرار", "مقطورة", "مولد كهرباء", "طلمبة", "حفار برمائي", "لنش/قارب", "معدة أخرى"] },
        { key: "fleetNumber", label: "رقم الأسطول أو العهدة", type: "text", maxLength: 120 },
        { key: "eng", label: "الهندسة أو الوحدة التابعة", type: "text", maxLength: 240 },
        { key: "workLocation", label: "موقع العمل الحالي", type: "text", maxLength: 300 },
        { key: "plateNumber", label: "رقم اللوحات", type: "text", maxLength: 100 },
        { key: "chassisNumber", label: "رقم الشاسيه", type: "text", maxLength: 160 },
        { key: "engineNumber", label: "رقم المحرك", type: "text", maxLength: 160 },
        { key: "manufacturer", label: "الماركة/الشركة المصنعة", type: "text", maxLength: 160 },
        { key: "model", label: "الموديل", type: "text", maxLength: 160 },
        { key: "manufactureYear", label: "سنة الصنع", type: "number", min: 1900, max: 2200, step: 1 },
        { key: "ownershipType", label: "نوع الحيازة", type: "select", options: ["مملوكة", "عهدة", "مؤجرة", "منتدبة", "متبرع بها", "أخرى"] },
        { key: "fuelType", label: "نوع الوقود/الطاقة", type: "select", options: ["بنزين", "سولار", "غاز طبيعي", "كهرباء", "هجين", "غير منطبق"] },
        { key: "powerOrCapacity", label: "القدرة أو الحمولة", type: "text", maxLength: 160 },
        { key: "odometerKm", label: "عداد المسافة (كم)", type: "number", min: 0, max: 1000000000, step: "any" },
        { key: "operatingHours", label: "ساعات التشغيل", type: "number", min: 0, max: 1000000000, step: "any" },
        { key: "custodian", label: "السائق أو مسؤول العهدة", type: "text", maxLength: 240 },
        { key: "licenseNumber", label: "رقم الترخيص", type: "text", maxLength: 120 },
        { key: "licenseExpiry", label: "انتهاء الترخيص", type: "date" },
        { key: "insuranceExpiry", label: "انتهاء التأمين", type: "date" },
        { key: "lastMaintenanceDate", label: "تاريخ آخر صيانة", type: "date" },
        { key: "nextMaintenanceDate", label: "موعد الصيانة القادمة", type: "date" },
        { key: "technicalCondition", label: "الحالة الفنية", type: "select", options: ["ممتازة", "جيدة", "متوسطة", "تحتاج صيانة", "عاطلة", "تكهين"] },
        { key: "status", label: "الحالة التشغيلية", type: "select", options: ["تعمل", "احتياطي", "في الصيانة", "متوقفة", "خارج الخدمة", "مكهّنة"] },
